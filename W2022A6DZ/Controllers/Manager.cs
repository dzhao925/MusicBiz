// ************************************************************************************
// WEB524 Project Template V3 2221 == 07070444-4433-40ce-bbd0-1757ff9ac6cb
...
namespace W2022A6DZ.Controllers
{
    public class Manager
    {
        ...
        {
            return mapper.Map<Artist, ArtistBaseViewModel>(ds.Artists.SingleOrDefault(a => a.Id == id));
        }
        ...
        {
            return mapper.Map<Album, AlbumBaseViewModel>(ds.Albums.SingleOrDefault(a => a.Id == id));
        }
        ...
        public AlbumBaseViewModel AlbumAdd(AlbumAddViewModel newItem)
        {
            ...
            addedItem.Artists.Add(ds.Artists.SingleOrDefault(a => a.Id == newItem.ArtistId));
            addedItem.Coordinator = userName;
            ds.SaveChanges();
        ...
        {
            return mapper.Map<Track, TrackBaseViewModel>(ds.Tracks.SingleOrDefault(t => t.Id == id));
        }
        public TrackAudioViewModel TrackAudioGetById(int id)
        {
            return mapper.Map<Track, TrackAudioViewModel>(ds.Tracks.SingleOrDefault(t => t.Id == id));
        }
        ...
        public TrackBaseViewModel TrackAdd(TrackAddViewModel newItem)
        {
            ...
            addedItem.Albums.Add(ds.Albums.SingleOrDefault(a => a.Id == newItem.AlbumId));
            addedItem.Clerk = userName;
            ds.SaveChanges();
        ...
        public ArtistBaseViewModel ArtistMediaItemAdd(ArtistMediaItemAddViewModel newItem)
        {
            ...
            else
            {
                ...
                addedItem.Artist = a;
                byte[] itemBytes = new byte[newItem.ContentUpload.ContentLength];
                newItem.ContentUpload.InputStream.Read(itemBytes, 0, newItem.ContentUpload.ContentLength);
